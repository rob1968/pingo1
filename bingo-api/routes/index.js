...
const { expressjwt: jwt } = require('express-jwt'); // Updated import for express-jwt v8+
...
router.put('/profile', auth, ctrlProfile.profileUpdate); // Added PUT route for profile update
